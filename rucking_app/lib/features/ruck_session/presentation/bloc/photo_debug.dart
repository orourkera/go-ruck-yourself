...
class PhotoDebugHelper {
  static void debugPhotoLoading(String? ruckId) {
    if (ruckId == null) {
      AppLogger.error(
          "[PHOTO_DEBUG] Cannot debug photo loading - ruckId is null");
      return;
    }
    ...
    try {
      ...
      AppLogger.debug(
          "[PHOTO_DEBUG] Current ActiveSessionBloc state: $currentState");

      // Dispatch LoadSessionForViewing and wait a bit
      AppLogger.debug(
          "[PHOTO_DEBUG] Dispatching LoadSessionForViewing for ruckId: $ruckId");
      ...
      Timer(const Duration(seconds: 1), () {
        ...
        Timer(const Duration(milliseconds: 500), () {
          AppLogger.debug(
              "[PHOTO_DEBUG] Now dispatching FetchSessionPhotosRequested");
          ...
          Timer(const Duration(seconds: 3), () {
            ...
            AppLogger.debug(
                "[PHOTO_DEBUG] State after photo loading: $updatedState");
          });
        });
      });
    } catch (e) {
