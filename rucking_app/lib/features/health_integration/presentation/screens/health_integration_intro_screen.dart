  ...
  Widget build(BuildContext context) {
    return BlocListener<HealthBloc, HealthState>(
      listenWhen: (previous, current) =>
          current is HealthAuthorizationStatus || current is HealthIntroShown,
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              AppLogger.info(
                                  'Requesting HealthKit authorization from intro screen');
                              try {
                                ...
                                AppLogger.info(
                                    'HealthKit authorization result: $authorized');

                                // Notify bloc of authorization result
                                context
                                    .read<HealthBloc>()
                                    .add(const RequestHealthAuthorization());
                              } catch (e) {
                                AppLogger.error(
                                    'Error requesting HealthKit authorization: $e');
                                // Show error to user
                                StyledSnackBar.showError(
                                  context: context,
                                  message:
                                      'Failed to request HealthKit access: $e',
                                );
                              }
                            },
