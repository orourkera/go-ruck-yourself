...
class GetDuelComments
    implements UseCase<List<DuelComment>, GetDuelCommentsParams> {
  final DuelsRepository repository;

  GetDuelComments(this.repository);

  @override
  Future<Either<Failure, List<DuelComment>>> call(
      GetDuelCommentsParams params) async {
