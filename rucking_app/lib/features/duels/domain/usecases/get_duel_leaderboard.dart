...
class GetDuelLeaderboard implements UseCase<List<DuelParticipant>, GetDuelLeaderboardParams> {
  final DuelsRepository repository;

  GetDuelLeaderboard(this.repository);

  @override
  Future<Either<Failure, List<DuelParticipant>>> call(GetDuelLeaderboardParams params) async {
