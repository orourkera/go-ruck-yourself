...
class User extends Equatable {
  ...
  factory User.fromJson(Map<String, dynamic> json) {
    ...
    final user = User(
      ...
      preferMetric: json['prefer_metric'] as bool? ??
          false, // Default to imperial/standard for US users
...
class UserStats extends Equatable {
  ...
  factory UserStats.fromJson(Map<String, dynamic> json) {
    return UserStats(
      totalRucks: json['total_rucks'] != null
          ? (json['total_rucks'] as num).toInt()
          : 0,
      ...
      totalCalories: json['total_calories'] != null
          ...
          : 0,
      totalPowerPoints: json['total_power_points'] != null
          ? (json['total_power_points'] as num).toInt()
          : 0,
  ...
  @override
  List<Object?> get props =>
      [totalRucks, totalDistanceKm, totalCalories, totalPowerPoints, thisMonth];
}
  ...
  factory MonthlyStats.fromJson(Map<String, dynamic> json) {
    return MonthlyStats(
      ...
      distanceKm: json['distance_km'] != null
          ...
          : 0.0,
      calories:
          json['calories'] != null ? (json['calories'] as num).toInt() : 0,
    );
  }
