...
class RuckSession extends Equatable {
  ...
  factory RuckSession.fromJson(Map<String, dynamic> json) {
    ...
    return RuckSession(
      ...
      plannedDurationMinutes:
          safeParseNum(json['planned_duration_minutes'])?.toInt(),
      ...
      elevationGainMeters:
          safeParseNum(json['elevation_gain_meters'])?.toDouble(),
      elevationLossMeters:
          safeParseNum(json['elevation_loss_meters'])?.toDouble(),
  ...
  Map<String, dynamic> toJson() {
    ...
    if (plannedDurationMinutes != null)
      result['planned_duration_minutes'] = plannedDurationMinutes;
    ...
    if (elevationGainMeters != null)
      result['elevation_gain_meters'] = elevationGainMeters;
    if (elevationLossMeters != null)
      result['elevation_loss_meters'] = elevationLossMeters;
    ...
    if (averagePaceMinKm != null)
      result['average_pace_min_km'] = averagePaceMinKm;
    if (routeMapUrl != null) result['route_map_url'] = routeMapUrl;
    if (waypoints != null)
      result['waypoints'] = waypoints!.map((e) => e.toJson()).toList();
