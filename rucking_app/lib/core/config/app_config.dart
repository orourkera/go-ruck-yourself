...
class AppConfig {
  ...
  static const List<double> metricWeightOptions = [
    0.0,
    2.6,
    4.5,
    9.0,
  ...
  static const List<double> standardWeightOptions = [
    0.0,
    10.0,
    15.0,
    20.0,
  ...
  static const bool useRustAchievements =
      false; // Feature flag for Rust backend
  static const bool enableAmazonGear = false; // Hide Amazon tab until PA-API access
