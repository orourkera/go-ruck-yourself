...
class EventsCacheService {
  ...
  Future<void> cacheEventDetails(String eventId, Map<String, dynamic> eventDetails) async {
    final prefs = await SharedPreferences.getInstance();
  ...
  Future<void> cacheEventComments(String eventId, List<dynamic> comments) async {
    final prefs = await SharedPreferences.getInstance();
  ...
  Future<void> cacheEventLeaderboard(String eventId, Map<String, dynamic> leaderboard) async {
    final prefs = await SharedPreferences.getInstance();
  ...
  Future<Map<String, dynamic>?> getCachedEventLeaderboard(String eventId) async {
    final prefs = await SharedPreferences.getInstance();
    final String key = '$_eventLeaderboardPrefix$eventId';
  ...
  String _generateCacheKey({
    ...
    if (includeParticipating != null) filters.add('participating:$includeParticipating');
    if (startDate != null) filters.add('start:${startDate.millisecondsSinceEpoch}');
