...
class StorageServiceImpl implements StorageService {
  ...
  Future<void> setSecureString(String key, String value) async {
    try {
      ...
      if (verified != value) {
        print(
            '[STORAGE ERROR] Secure storage write verification failed for key: $key');
      } else {
        print('[STORAGE] Secure storage write successful for key: $key');
      }
    } catch (e) {
      print(
          '[STORAGE ERROR] Failed to write secure string for key: $key, error: $e');
      rethrow;
    }
  }
  ...
  Future<String?> getSecureString(String key) async {
    try {
      ...
      print(
          '[STORAGE] Secure storage read for key: $key, found: ${value != null}');
      return value;
    } catch (e) {
      print(
          '[STORAGE ERROR] Failed to read secure string for key: $key, error: $e');
      return null;
    }
  }
