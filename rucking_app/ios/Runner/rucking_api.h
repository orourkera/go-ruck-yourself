...
- (void)updateSessionOnWatchDistance:(double)distance duration:(double)duration pace:(double)pace isPaused:(BOOL)isPaused calories:(double)calories elevationGain:(double)elevationGain elevationLoss:(double)elevationLoss completion:(void (^)(NSNumber *_Nullable, FlutterError *_Nullable))completion;
...
- (void)updateSessionOnWatchDistance:(double)distance duration:(double)duration pace:(double)pace isPaused:(BOOL)isPaused calories:(double)calories elevationGain:(double)elevationGain elevationLoss:(double)elevationLoss error:(FlutterError *_Nullable *_Nonnull)error;
