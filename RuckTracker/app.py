    ...
    def before_send_filter(event, hint):
        ...
        if 'request' in event:
            ...
            bot_url_patterns = [
                ...
                'wp-admin', 'wp-login', 'wp-content', 'wp-includes', 'wp-json', 'admin', 'phpmyadmin', 'xmlrpc.php',
...
from RuckTracker.api.live_following import live_following_bp
app.register_blueprint(ruck_messages_bp, url_prefix='/api')
app.register_blueprint(live_following_bp, url_prefix='/api')
import os as _os
...
from .api.ai_cheerleader import (
    ...
    AICheerleaderLogsCheckResource,
)
...
api.add_resource(AICheerleaderLogsCheckResource, '/api/ai-cheerleader/logs/check')
